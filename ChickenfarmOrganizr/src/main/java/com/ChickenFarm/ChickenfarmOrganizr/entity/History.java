...
import com.ChickenFarm.ChickenfarmOrganizr.data.historyAndGroupOfChickenChanging.HistoryDTO;
...
public class History {
    ...
    public static History HistorsxEntity(HistoryDTO historyDTO) {

        Objects.requireNonNull(historyDTO);

        History history = new History();

        history.chickenHistoryId = historyDTO.getChickenHistoryId();
        history.dateOfJoin = historyDTO.getDateOfJoin();
        history.dateOfLeave = historyDTO.getDateOfLeave();
