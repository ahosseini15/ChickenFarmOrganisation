...
@Data
@AllArgsConstructor
public class AddVaccinationsDTO {
    ...
    public static AddVaccinationsDTO vaccinationOfOneChickenDTO(@NonNull Vaccination vaccination){
